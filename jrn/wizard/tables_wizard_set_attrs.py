...
class tables_wizard_set_attrs(models.TransientModel):
    ...
    check_insert = fields.Boolean(string='Check insert', default = False)
    check_update = fields.Boolean(string='Check update', default = False)
    check_delete = fields.Boolean(string='Check delete', default = False)
    ...
    def action_set_attrs(self):
        ...
        for table in tables:
            table.check_insert = self.check_insert
            table.check_update = self.check_update
            table.check_delete = self.check_delete
        return None
