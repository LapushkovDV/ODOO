odoo.define("workplace_task_dashboard.dashboard_view", function (require) {
    "use strict";
    ...
    const DashBoard = AbstractAction.extend({
        template: "WorkplaceTaskDashboard",
        events: {
        ...
        init: function (parent, context) {
            ...
            this.dashboards_templates = ["WorkplaceTaskDashboard"];
        },
...
//            self.render_team_ticket_done_graph();
        ...
        render_dashboards: function () {
            ...
            _.each(templates, function (template) {
                self.$(".workplace_task_dashboard_main").append(QWeb.render(template, {widget: self}));
            });
    ...
    core.action_registry.add("workplace_task_dashboard", DashBoard);
    return DashBoard;
});
